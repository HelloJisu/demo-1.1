...
public class TreatActivity_forehead extends AppCompatActivity {
  ...
  public static Activity treatforehead;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_treat_forehead);
    treatforehead=TreatActivity_forehead.this;
    home = getIntent();
    ...
    question = findViewById(R.id.question_f);
    forehead =  (ImageView)findViewById(R.id.forehead_f);
    underleft =  (ImageView)findViewById(R.id.underleft_f);
    underright =  (ImageView)findViewById(R.id.underright_f);
    cheekl =  (ImageView)findViewById(R.id.cheek_left_f);
    cheekr =  (ImageView)findViewById(R.id.cheek_right_f);
    mouth =  (ImageView)findViewById(R.id.mouth_f);
    eyeleft = (ImageView)findViewById(R.id.eyeleft_f);
    eyeright=(ImageView)findViewById(R.id.eyeright_f);
    component_txt=(TextView)findViewById(R.id.componenttxt_f);
    back=(ImageView)findViewById(R.id.backw_f);
    content1 = findViewById(R.id.treatup_f);
    content2 = findViewById(R.id.treatdown_f);
  ...
  private void setResult() {
    ...
    if (level == 1) {
      ...
      if (treatResult.contains("under_l")) {
        ...
        forehead.setImageResource(R.drawable.foreheadlevel1);
      }
    ...
    if (level == 2) {
      if (treatResult.contains("under_l")) {
        ...
        forehead.setImageResource(R.drawable.foreheadlevel2);
      }
      component_txt.setText("PLEASE SET THE DEVICE\nON LEVEL 2,\nAND SELECT STARTIG AREA");
    } else {
    ...
    if (level == 3) {
      if (treatResult.contains("under_l")) {
        ...
        forehead.setImageResource(R.drawable.foreheadlevel3);
      }
      component_txt.setText("PLEASE SET THE DEVICE\nON LEVEL 3,\nAND SELECT STARTIG AREA");
    }
  }
