...
public class TreatActivity_eyeright2 extends AppCompatActivity {
    ...
    ImageView e_tright_line1,e_tright_line2,e_tright_line3,e_tright_line4,e_tright_line5,e_tright_line6,
            e_tright_line7;
    TimerTask second;
    String part;
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (count_ul == 1) {
                            ...
                            e_tright_line1.setBackgroundResource(R.drawable.eyerightanim1);
                            etanim1 = (AnimationDrawable) e_tright_line1.getBackground();
                            etanim1.start();
                        }
                        if (count_ul == 2) {
                            etanim1.stop();
                            e_tright_line1.setBackgroundResource(R.drawable.erf1);
                            e_tright_line2.setBackgroundResource(R.drawable.eyerightanim2);
                            etanim2 = (AnimationDrawable) e_tright_line2.getBackground();
                            etanim2.start();
                            e_tright_txt.setText("6 left");
                        }
                        if (count_ul == 3) {
                            etanim2.stop();
                            e_tright_line2.setBackgroundResource(R.drawable.erf2);
                            e_tright_line3.setBackgroundResource(R.drawable.eyerightanim3);
                            etanim3 = (AnimationDrawable) e_tright_line3.getBackground();
                            etanim3.start();
                            e_tright_txt.setText("5 left");
                        }
                        if (count_ul == 4) {
                            etanim3.stop();
                            e_tright_line3.setBackgroundResource(R.drawable.erf3);
                            e_tright_line4.setBackgroundResource(R.drawable.eyerightanim4);
                            etanim4 = (AnimationDrawable) e_tright_line4.getBackground();
                            etanim4.start();
                            e_tright_txt.setText("4 left");
                        }
                        if (count_ul == 5) {
                            etanim4.stop();
                            e_tright_line4.setBackgroundResource(R.drawable.erf4);
                            e_tright_line5.setBackgroundResource(R.drawable.eyerightanim5);
                            etanim5 = (AnimationDrawable) e_tright_line5.getBackground();
                            etanim5.start();
                            e_tright_txt.setText("3 left");
                        }
                        if (count_ul == 6) {
                            etanim5.stop();
                            e_tright_line5.setBackgroundResource(R.drawable.erf5);
                            e_tright_line6.setBackgroundResource(R.drawable.eyerightanim6);
                            etanim6 = (AnimationDrawable) e_tright_line6.getBackground();
                            etanim6.start();
                            e_tright_txt.setText("2 left");
                        }
                        if (count_ul == 7) {
                            etanim6.stop();
                            e_tright_line6.setBackgroundResource(R.drawable.erf6);
                            e_tright_line7.setBackgroundResource(R.drawable.eyerightanim7);
                            etanim7 = (AnimationDrawable) e_tright_line7.getBackground();
                            etanim7.start();
                            e_tright_txt.setText("1 left");
                        }
                        if (count_ul == 8) {
                            etanim7.stop();
                            e_tright_line7.setBackgroundResource(R.drawable.erf7);
                        ...
                        if(count_ul==9){
                            ...
                            if (! TreatActivity_eyeright2.this.isFinishing()) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_treat_eyeright2);
        underleftativity=TreatActivity_eyeright2.this;
        ...
        //값 받아오기
        question = findViewById(R.id.question_er);
        e_tright_line1=(ImageView)findViewById(R.id.e_tright_line1);
        e_tright_line2=(ImageView)findViewById(R.id.e_tright_line2);
        e_tright_line3=(ImageView)findViewById(R.id.e_tright_line3);
        e_tright_line4=(ImageView)findViewById(R.id.e_tright_line4);
        e_tright_line5=(ImageView)findViewById(R.id.e_tright_line5);
        e_tright_line6=(ImageView)findViewById(R.id.e_tright_line6);
        e_tright_line7=(ImageView)findViewById(R.id.e_tright_line7);
        e_tright_txt=(TextView)findViewById(R.id.e_tright_txt);
        component_txt=findViewById(R.id.componenttxt_er);
